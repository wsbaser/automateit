...
namespace selenium.core.tests {
    ...
    public class UriMatcherTest {
        ...
        public void AbsolutePathDoesNotMatch() {
            var uriMatcher = new UriMatcher("newssubscriptions/subscribeaction111/",
                                            new Dictionary<string, string>(),
                                            new StringDictionary());
            var uri = new Uri("http://moskva.dr-bee.ru/newssubscriptions/subscribeaction/?type=AddSubscription");
            UriMatchResult uriMatchResult = uriMatcher.Match(uri, "/");
            Assert.False(uriMatchResult.Success);
        }

        [Test]
        public void AbsolutePathMatches() {
            var uriMatcher = new UriMatcher("newssubscriptions/subscribeaction/", new Dictionary<string, string>(),
                                            new StringDictionary());
            var uri = new Uri("http://moskva.dr-bee.ru/newssubscriptions/subscribeaction/?type=AddSubscription");
            UriMatchResult uriMatchResult = uriMatcher.Match(uri, "/");
        ...
        public void DataDoesNotMatch() {
            ...
            var uriMatcher = new UriMatcher("customers/products/mobile/services/details/{tariff}/",
                                            data,
                                            new StringDictionary());
            var uri = new Uri("http://moskva.beeline.ru/" +
        ...
        public void ExtractDataFromUri() {
            ...
            Assert.AreEqual("highway-1gb-nedelya-besplatno", uriMatchResult.Data["tariff"],
        ...
        public void ExtractParamFromUri() {
            ...
            Assert.AreEqual("cellphone", uriMatchResult.Params["deviceTypeId"],
                            "Матчер обнаружил некорректный параметр");
        }
