...
namespace selenium.core.Framework.Page {
    public static class WebPageBuilder {
        ...
        public static IComponent CreateComponent(IPage page, object componentContainer, Type type, IComponentAttribute attribute) {
        ...
        public static void InitComponents(IPage page, object componentsContainer) {
            ...
            Type type = componentsContainer.GetType();
